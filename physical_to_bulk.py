...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  7 11:27:57 2025
...
# Load your dataset
filepath = 'a'  # Path to data
df = pd.read_feather(filepath, columns=None, use_threads=True)
df = df.dropna(axis=0)
X_val = df["size", "restitution", "sliding_friction", "rolling_friction"]
Y_val = df['dynamic_angle_of_repose'].to_numpy()
